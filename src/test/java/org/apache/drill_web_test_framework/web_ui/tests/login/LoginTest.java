 ...
 */
package org.apache.drill_web_test_framework.web_ui.tests.login;
...
import org.apache.drill_web_test_framework.web_ui.steps.ProfilesSteps;
...
public class LoginTest extends BaseTest {
  ...
  private final ProfilesSteps profilesSteps = BaseSteps.getSteps(ProfilesSteps.class);
  private final String defaultQueryString = "SELECT * FROM cp.`employee.json` LIMIT 20";
  private final String completedStatus = "COMPLETED";
